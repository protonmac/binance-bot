...
import pl.bestapp.binancebot.client.BinanceApiAsyncRestClient;
import pl.bestapp.binancebot.client.BinanceApiCallback;
import pl.bestapp.binancebot.client.constant.BinanceApiConstants;
import pl.bestapp.binancebot.client.domain.account.*;
import pl.bestapp.binancebot.client.domain.account.request.AllOrdersRequest;
import pl.bestapp.binancebot.client.domain.account.request.CancelOrderRequest;
import pl.bestapp.binancebot.client.domain.account.request.OrderRequest;
import pl.bestapp.binancebot.client.domain.account.request.OrderStatusRequest;
import pl.bestapp.binancebot.client.domain.event.ListenKey;
import pl.bestapp.binancebot.client.domain.general.ServerTime;
import pl.bestapp.binancebot.client.domain.market.*;

import java.util.List;

import static pl.bestapp.binancebot.client.impl.BinanceApiServiceGenerator.createService;
